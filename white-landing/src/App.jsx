      ...
      <header className="hero" id="inicio">
        <div className="hero-content">
          <div className="hero-left">
            <span className="hero-badge">Fundación White International Ministry</span>
            <h1>Transformando vidas mediante el amor de Dios</h1>
            <p>Impactamos comunidades mediante acciones sociales, acompañamiento espiritual y proyectos que llevan esperanza a diferentes lugares del mundo.</p>
            <div className="buttons">
              <a href="#proyectos" className="btn">Nuestros proyectos</a>
              <a href="#donaciones" className="btn-outline">Donar ahora</a>
            </div>
          </div>
          <div className="hero-right">
            <img src={`${import.meta.env.BASE_URL}logo4.png`} alt="WHITE" />
          </div>
        </div>
      </header>
      ...
      <section className="section" id="equipo">
        ...
        <div className="cards">
          ...
          <div className="card team-card">
            <img src={`${import.meta.env.BASE_URL}Jose.jpeg`} alt="Jose Fernando Miranda Gómez" className="team-photo" />
            <span className="cargo">Director General</span>
